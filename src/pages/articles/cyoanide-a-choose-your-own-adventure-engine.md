...
category: "projects"
socialImage: "/articles/cyoanide-a-choose-your-own-adventure-engine/cyoanide-main-page-screenshot.webp"
tags:
  - "Game Development"
  - "Project"
  - "Web Development"
description: "How I built Cyoanide, an open-source, browser-based choose-your-own-adventure engine with Gatsby and MDX."
---
...
<img src="/articles/cyoanide-a-choose-your-own-adventure-engine/cyoanide-main-page-screenshot.webp" alt="Cyoanide main page" width="802" height="932" loading="lazy" decoding="async" />
...
<img src="/articles/cyoanide-a-choose-your-own-adventure-engine/cyoanide-in-game-screenshot.webp" alt="Cyoanide in-game page" width="766" height="840" loading="lazy" decoding="async" />
...
{
  !getLevelState().includes("investigate-bunker") ? (
...
const seenBunkerActions = ["investigate-bunker", "keep-your-distance", "follow-stench"].filter(
  (it) => levelState.includes(it),
);
...
```js
["investigate-bunker", "keep-your-distance", "follow-stench"].filter((it) =>
  getLevelState().includes(it),
).length >= 2 ? (
  <>...</>
) : (
  <>...</>
