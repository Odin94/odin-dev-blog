const Impressum = () => {
    return (
        <div className="w-full content-center px-50">
            <h1 className="mb-5 text-5xl font-bold">Impressum</h1>
            <h2>(Required by German law)</h2>
            ...
            <p className="font-bold">
                E-Mail: elmonoxo (at) tutamail (punkt) com
            </p>
            <p>
            ...
            <p>
                ...
                <h4 className="my-2 font-bold">Haftung für Inhalte</h4>
            ...
            <h4 className="my-2 font-bold">Urheberrecht</h4>
            <p>
